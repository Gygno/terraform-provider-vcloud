...
description: |-
  Provides a resource to manage Viettel IDC Tenant Manager Organization.
---
...
* `org_vcloud_count` - Number of VDCs belonging to this Organization
...
```
terraform import vcloud_tm_org.imported my-org-name
```
